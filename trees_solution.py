class BST:
    ...
    def _insert(self, data, node):
        """
        This method has been completed already. 
        """
        if data < node.data:
    ...
    def _contains(self, data, node):
        ...
        the data we are looking for. This function is incomplete.
        """
        # If we have reached the end and
        # the data was not found, retrun false
        if node == None:
            return False
        # If we have found the node we
        # are looking for, return true
        elif data == node.data:
            return True
        # If the data is less than the data
        # in the current node, move to the left
        elif data < node.data:
